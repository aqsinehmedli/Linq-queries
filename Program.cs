...
////var debt = debtors.Where(x => x.Email.EndsWith("rhyta.com")|| x.Email.EndsWith("dayrep.com")).ToList();
...
////var db = debtors.Where(d => d.Birthday.Year > 1988 && d.Birthday.Year < 1998);
////foreach (var item in db)
////{
////    Console.WriteLine(item);
////}
////4) Borcu 5000-den cox olmayan borclularic cixartmag
////var db = debtors.Where(x => x.Dept > 5000).ToList();
////foreach (var item in db)
////{
////    Console.WriteLine(item);
////}
...
////var db = debtors.Where(x=>x.FullName.Length >18 || x.Phone.Count(c => c == '7') >= 2).ToList();
////foreach (var item in db)
////{
////    Console.WriteLine(item);
////}
...
////var db = debtors.Where(d => d.Birthday.Month == 12 || d.Birthday.Month == 1);
////foreach (var item in db)
////{
////    Console.WriteLine(item);
////}
...
////           .Select(d => new { d.FullName, d.Birthday, d.Dept });
////foreach (var item in filteredDebtors)
////{
////    Console.WriteLine(item);
////}
...
////var top5Debtors = debtors
////             .OrderByDescending(d => d.Dept)
////             .Take(5)
////             .ToList();

////foreach (var debtor in top5Debtors)
////{
////    Console.WriteLine($"{debtor.FullName} - Borc: {debtor.Dept}");
////}


////16)2ci dunya muharibesin gormush borclularin siyahisi cixartmaq

////var db = debtors.Where(d => d.Birthday.Year < 1945 && d.Birthday.Year>1941);
...
////var uniqueDigitDebtors = debtors
////                .Where(d => HasUniqueDigits(d.Phone))
////                .Select(d => new { d.FullName, d.Phone, d.Dept })
////                .ToList();
////foreach (var debtor in uniqueDigitDebtors)
////{
////    Console.WriteLine($"{debtor.FullName} - Telefon Numarası: {debtor.Phone} - Borç: {debtor.Dept}");
////}
////static bool HasUniqueDigits(string phoneNumber)
////{
////    return phoneNumber.Distinct().Count() == phoneNumber.Length;
////}

//char[] requiredChars = { 's', 'm', 'l', 'i', 'e' };

//var filteredDebtors = debtors
//    .Where(d => requiredChars.All(c => d.FullName.ToLower().Contains(c)))
//    .Select(d => new { d.FullName, d.Phone, d.Dept })
//    .ToList();
